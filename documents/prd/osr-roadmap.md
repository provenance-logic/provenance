...
> **⚠️ Stale as of 2026-05-21; further updated 2026-05-22.** This roadmap was built around the assumption that all OSR blockers were closed and only Stage 5 polish remained. That framing didn't survive the 2026-05-21 session — [B-063](../bugs/open.md#B-063) (connector framework is register-only for 9 of 12 advertised types) is the new sole OSR Blocker, and the whole "2–3 days remaining" / "v0.1.0-osr in 2 weeks" framing below is wrong. **The full PRD is going back to the drawing board on the 2026-05-24 weekend.** This document survives below for context only; expect it to be replaced or substantially restructured after that conversation. Until then, the truthful current state is in [`status-board.md`](../status-board.md).
>
> **2026-05-22 input for the weekend overhaul:**
>
> - [`documents/audits/claim-vs-code-2026-05-22.md`](../audits/claim-vs-code-2026-05-22.md) — claim-vs-code audit. 12 findings; none new-blocker. Most architectural and operational claims in CLAUDE.md verified real (5 of 5 non-negotiable constraints, 9 of 10 operational rules). Hollowness lives in the docs, not the codebase — the "B-063 pattern" is narrower than initially feared.
> - [`documents/architecture/connector-lift-survey-2026-05-22.md`](../architecture/connector-lift-survey-2026-05-22.md) — per-type lift estimates for the 9 unimplemented connector types. **Reframes B-063 Option 1 from "8-16 weeks" to ~41-86 hours (1.5-2.5 person-weeks).** Surfaces a possible Option 4 (incremental tranches over 3-4 weeks, shipping the connector count week-over-week). The engineering side just stopped being the gating factor; the Sunday decision turns on product / market / brand questions.
> - [`documents/architecture/adr/ADR-010-rls-by-default.md`](../architecture/adr/ADR-010-rls-by-default.md) — design pass for [B-062](../bugs/open.md#B-062). Proposed status. Decision: formalize the explicit-`orgId`-filter pattern at the service layer as load-bearing; RLS stays as Phase 6 hardening backstop. Implementation deferred.
