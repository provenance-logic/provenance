    ...
    ports: [
      {
        ...
        contract: {
          ...
          connectionDetails: {
            kind: 'rest_api',
            baseUrl: 'https://api.beta.example.com/kyc/v1',
    ...
    ports: [
      {
        ...
        contract: {
          ...
          connectionDetails: {
            ...
            bootstrapServers: 'stream.beta.example.com:9093',
            topic: 'transactions.scored.v1',
    ...
    ports: [
      {
        ...
        contract: {
          ...
          connectionDetails: {
            kind: 'sql_jdbc',
            host: 'warehouse.beta.example.com',
            port: 5432,
            database: 'risk',
            schema: 'public',
            authMethod: 'iam',
